...
//#define _useTimer3
//#define _useTimer4
typedef enum { _timer5, _timer1, _Nbr_10timers } timer10_Sequence_t ;

#elif defined(__AVR_ATmega32U4__)
#define _useTimer3
#define _useTimer1
typedef enum { _timer3, _timer1, _Nbr_10timers } timer10_Sequence_t ;
...
#define SERVOS_PER_TIMER       48     // the maximum number of servos controlled by one timer
