...
RF24 radio(47, 46);   // nRF24L01 (CE, CSN)
...
void loop() {
  ...
  // Initial and resting position ( if (data.button4 == 0) )
  else  {
    initialPosition();
  ...
  // Speed adjustment
  //if (data.pot1 >= 15 && data.pot1 <= 60) {
    speedV = map(data.pot1,0,255,50,10);
    delay(speedV);
  //}
}
