...
/*Declaring a seperate object for each board
 *---------------- Start ---------------------------
 */
Adafruit_PWMServoDriver pwm1 = Adafruit_PWMServoDriver(0x40); // Address for board 1
Adafruit_PWMServoDriver pwm2 = Adafruit_PWMServoDriver(0x41); // Address for board 2

void setup() {

// Call begin on each object, and control each servo through the object it's attached to. 
  ...
  // Set pwm frequency for board 1
  pwm1.setPWMFreq(1600); // Max PWM Frequency

  // Initializing board 2
  pwm2.begin(); 

  // Set pwm frequency for board 2
  pwm2.setPWMFreq(1600); // Max PWM Frewuency
}
