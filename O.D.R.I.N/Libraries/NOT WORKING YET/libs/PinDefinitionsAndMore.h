...
#define SERVO1_PIN 11 // For ATmega328 pins 9 + 10 are connected to timer 2 and can therefore be used also by the Lightweight Servo library
#define SERVO2_PIN 12
#define SERVO3_PIN 13

#define SERVO4_PIN 8 // For ATmega328 pins 9 + 10 are connected to timer 2 and can therefore be used also by the Lightweight Servo library
#define SERVO5_PIN 9
#define SERVO6_PIN 10

#define SERVO7_PIN 5 // For ATmega328 pins 9 + 10 are connected to timer 2 and can therefore be used also by the Lightweight Servo library
#define SERVO8_PIN 6
#define SERVO9_PIN 7

#define SERVO10_PIN 2 // For ATmega328 pins 9 + 10 are connected to timer 2 and can therefore be used also by the Lightweight Servo library
#define SERVO11_PIN 3
